...
?>
<?php
  $where = 'WHERE stock<minstock AND store_id='.$batid;
  if(isset($_GET['category'])){
    $catid = $_GET['category'];
    $where = 'WHERE stock<minstock AND store_id='.$batid.' AND category_id ='.$catid;
  }
...
<head>
  ...
  <title>Denvis Bookshop | Products With Low Stock</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <div class="row mb-2">
          ...
          <div class="col-sm-2">
              <button class="btn btn-flat btn-success" style="width:100%;"><i class="fa fa-folder-plus"> </i>  Allocate Product</button>
          </div>
          <div class="col-sm-5">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="./home.php">Home</a></li>
              <li class="breadcrumb-item"><a href="./branches.php">Branches</a></li>
              <li class="breadcrumb-item"><a href="./manager.php?bid=<?php echo $sat['store_id']?>"><?php echo $sat['store_name']?></a></li>
                      ...
                      foreach($stmt as $row){
                        ...
                        echo "
                          <tr>
                            ...
                            <td>".$row['stock']."</td>
                            <td>
                              <button class='btn btn-success btn-sm edit btn-flat' data-id='".$row['id']."'><i class='fa fa-plus'></i> Add Stock</button>
...
$(function(){
  ...
  $('#select_category').change(function(){
    var val = $(this).val();
    if(val == 0){
      window.location = 'allocationslowb.php?sto=<?php echo $batid?>';
    }
    else{
      window.location = 'allocationslowb.php?sto=<?php echo $batid?>&category='+val;
    }
  });
