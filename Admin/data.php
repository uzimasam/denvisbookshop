...
<head>
  ...
  <title>Denvis Bookshop | Product List</title>
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-2">
              <a href="#addnew" data-toggle="modal" class="btn btn-success btn-block btn-flat" id="addproduct"><i class="fa fa-folder-plus"> </i>  Add Product</a>
          </div>
          <div class="col-sm-5">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php
                    ...
                    try{
                      $no = 1;
                      $now = date('Y-m-d');
                      $stmt = $conn->prepare("SELECT * FROM products $where ORDER BY name");
                      $stmt->execute();
                      foreach($stmt as $row){
...
$(function(){
  ...
  $('#select_category').change(function(){
    ...
    if(val == 0){
      ...
      window.location = 'data.php?category='+val;
    }
  });
...
function getRow(id){
  $.ajax({
    ...
    success: function(response){
      ...
      CKEDITOR.instances["summernote"].setData(response.description);
      getCategory();
    }
  });
}
