...
<head>
    ...
    <title>Denvis Bookshop | Search</title>
...
<body>
    ...
    <header class="header">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3">
                    <h1 class="header-logo navbar-brand logo-mini" style="padding-top:25px; color: black;"><b><span style="color:tomato;">Denvis</span>Bookshop</b></h1>
                </div>
                <div class="col-lg-7">
